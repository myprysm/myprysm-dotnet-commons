...
public class SingleValueObjectConverterTests : ServiceTests
{
    ...
    {
        Json.DefaultSettings.ConfigureValueObjectConverters();
    }
    ...
    public void DeserializeNullableIntWithoutValue()
    {
        ...
        // Act
        var with = this.Converter.Read<WithNullableIntSingleValue>(json);
    ...
    {
        // Act
        var stringSvo = this.Converter.Read<StringSvo>(json);
    ...
    {
        // Act
        var intSvo = this.Converter.Read<IntSvo>(json);
    ...
    {
        // Act
        var intSvo = this.Converter.Read<EnumSvo>(json);
    ...
    {
        services.AddSystemTextJsonConverter(settings => { settings.ConfigureValueObjectConverters(); });
    }
}
